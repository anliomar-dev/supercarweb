<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        if (!isset($_SESSION['username'])) {
            ...
            $marque = mysqli_real_escape_string($dbd, $_POST["marque_voiture"]);
            $modele = mysqli_real_escape_string($dbd, $_POST["model_voiture"]);

            // Requête d'insertion avec une déclaration paramétrée
            $inserer = "INSERT INTO demandeessaie (Nom, Prenom, DateEssaie, HeureEssaie, Marque, Modele)
                        VALUES ('$nom', '$prenom', '$date', '$heure', '$marque', '$modele')";
